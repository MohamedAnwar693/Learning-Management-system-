import { useGetHeroDataQuery ,useEditLayoutMutation} from '@/app/redux/features/layout/layoutApi';
...
const EditHero:FC<Props> = (props: Props) => {
  ...
  return (
    <>
        <div className='w-full 1000px:flex items-center mt-56'>
            <div className='flex top-[100px] 1000px:top-[unset] 1500px:h-[700px] 1500px:w-[700px] 1100px:h-[500px] 1100px:w-[500px] h-[50vh] w-[50vh] hero_animation rounded-[50%] 1100px:left-[18rem] 1500px:left-[21rem]'>
