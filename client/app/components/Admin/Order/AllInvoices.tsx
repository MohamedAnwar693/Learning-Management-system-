...
import { useGatAllUsersQuery } from '@/app/redux/features/user/userApi';
...
const AllInvoices = ({isDashboard}:Props) => {
    ...
    const { data: usersData } = useGatAllUsersQuery({});
    ...
    const rows:any = [
        {
            ...
            userEmail: "programmer@gmail.com",
        ...
        {
            id: "1234556777678",
            userName: "kenzi madbolly",
            userEmail: "kenzi@gmail.com",
            title: "Life style",
            price: "$600",
